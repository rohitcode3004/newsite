...
<p class="bg-info" id="msg"><?php echo (isset($_SESSION['msg'])) ? $_SESSION['msg'] : ''; ?></p>
				...
				<form class="loginForm" method="post" action="function.php?type=signup">
					<div class="input-group">
						<input type="text" id="name" class="form-control" name="name" placeholder="Full Name">
						<input type="password" id="paw" class="form-control" name="password" placeholder="Password">
                        <input type="password" id="paw" class="form-control" name="cpassword" placeholder="Confirm Password">
                        </div>
                      
                        <div class="input-group" data-validate="email">
						<input type="text" class="form-control" id="validate-email" name="username" placeholder="Email" required>
